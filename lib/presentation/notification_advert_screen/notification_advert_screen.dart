...
class NotificationAdvertSettingsScreen extends StatelessWidget {
  const NotificationAdvertSettingsScreen({super.key});
  @override
  Widget build(BuildContext context) {
    final model = context.watch<NotificationAdvertViewModel>();
