...
//       }
//       if (createdAt
//           .isBefore(DateTime.now().subtract(const Duration(days: 60)))) {
//         setBefore2MonthsAgoReviewsRatings(nmId, rating);
//       }
//       if (createdAt
...
//   // Reviews before week
//   Map<int, int> _before2MonthsAgoReviewsRatings = {};
//   Map<int, int> _before2MonthAgoReviewsRatingsLength = {};
//   void setBefore2MonthsAgoReviewsRatings(int nmIi, int value) {
//     if (_before2MonthsAgoReviewsRatings.containsKey(nmIi)) {
//       _before2MonthsAgoReviewsRatings[nmIi] =
//           _before2MonthsAgoReviewsRatings[nmIi]! + value;
//       _before2MonthAgoReviewsRatingsLength[nmIi] =
//           _before2MonthAgoReviewsRatingsLength[nmIi]! + 1;
//     } else {
//       _before2MonthsAgoReviewsRatings[nmIi] = value;
//       _before2MonthAgoReviewsRatingsLength[nmIi] = 1;
//     }
...
//   double before2MonthsAgoReviewsRatings(int nmId) {
//     final sum = _before2MonthsAgoReviewsRatings[nmId] ?? 0;
//     final len = _before2MonthAgoReviewsRatingsLength[nmId] ?? 0;
//     if (len == 0) {
//       return 0;
//     }
//     return sum / len;
